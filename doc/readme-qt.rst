KatersLTC-Qt: Qt4 GUI for KatersLTC
================================
...
A warning for people using the *static binary* version of KatersLTC on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of KatersLTC is linked against libdb4.8 (see also `this Debian issue`_).
