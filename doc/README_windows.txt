...
Intro
-----
KatersLTC is a free open source peer-to-peer electronic cash system that is
...
incoming connections.  KatersLTC works without incoming connections,
but allowing incoming connections helps the KatersLTC network.
