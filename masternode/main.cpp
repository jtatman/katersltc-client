...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// #### EDIT HERE - change pszTimestamp

        // Genesis block
        const char* pszTimestamp = "All Good Things Come To Those Who Masturbate";
        unsigned int nTimeGenesis=1617255477;
        unsigned int nNonceGenesis=0;

        if (fTestNet)
        {
            pszTimestamp="All Good Things Come To Those Who Masturbate";
            nTimeGenesis=1617255551;
            nNonceGenesis=1;
        }
