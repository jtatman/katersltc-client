...
// this sets max coin supply - CONFIG
static const int64 MAX_MONEY = 18000000 * COIN; // maximum number of coins
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
// this sets time when coinbase recieves initial amount
